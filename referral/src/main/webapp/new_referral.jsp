...
<body>
	...
	<form name="frmReferral" action="insert">
		<table>
			...
			<tr>
				<td><input type="number" name="float_hours"
					placeholder="Currently weekly support hours(E.g.: 4.5)" class="Box1"></td>
			</tr>

			<tr>
				<td><input type="text" name="txt_reasonref"
					placeholder="Insert all the reasons for the referral." class="Box2"></td>
			</tr>
			...
			<tr>
				<td><input type="text"   name="txt_acomneeds"
					placeholder="Acommodation needs - Will adaptions be required?" class="Box2"></td>
			</tr>
		...
		<input type="button" value="Add" class="button1" onclick="validate()">
	</form>
